...
public class C02_TreeMapMethod {
    public static void main(String[] args) {
        ...
        System.out.println(harfler.ceilingKey("K")); // K\ Verilen anahtara eşit veya ondan büyük olan en küçük anahtarı döndürür;
        //  böyle bir anahtar yoksa null değerini döndürür.
        System.out.println(harfler.ceilingKey("N")); // T
        System.out.println(harfler.ceilingKey("U")); // Z

        System.out.println(harfler.higherKey("K")); // L Verilen anahtardan kesinlikle daha büyük olan en küçük anahtarı döndürür
        // veya böyle bir anahtar yoksa null değerini döndürür.
        System.out.println(harfler.higherKey("N")); // T
        System.out.println(harfler.higherKey("U")); // Z

        System.out.println(harfler.ceilingEntry("K")); //K=25 Verilen anahtardan büyük veya ona eşit olan en küçük anahtarla
        // ilişkili anahtar/değer eşlemesini döndürür veya böyle bir anahtar yoksa null değerini döndürür.
